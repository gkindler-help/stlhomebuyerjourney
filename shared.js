...
var CHAPTERS = [
  {ch:1, file:'01-preapproval.html',    label:'What happens when you contact an agent'},
  {ch:2, file:'02-affordability.html',  label:'Where buyers overpay before making an offer'},
  {ch:3, file:'03-interior.html',       label:'What to look for at a showing'},
  {ch:4, file:'05-pre-offer.html',      label:'Pre-offer strategy'},
  {ch:5, file:'06-under-contract.html', label:'Under contract \u2014 Day Zero'},
  {ch:6, file:'06b-deadlines.html',     label:'The deadlines \u2014 loan, appraisal, title'},
  {ch:7, file:'07-inspection.html',     label:'The inspection report \u2014 what matters'},
  {ch:8, file:'08-walkthrough.html',    label:'Final walk-through'},
  {ch:9, file:'09-closing.html',        label:'Closing day'}
];
